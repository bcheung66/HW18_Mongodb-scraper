...
$(document).ready(function () {
  ...
  function renderNotesList(data) {
    ...
    if (!data.notes.length) {
      ...
      for (var i = 0; i < data.notes.length; i++) {
        ...
        currentNote.children("button").data("_id", data._id);
        currentNote.children("button").data("_note"+i, data.notes[i]);
  ...
  function handleArticleDelete() {
    ...
    $.ajax({
      method: "DELETE",
      url: "/api/notes/" + articleToDelete._id
    }).then(function (data) {
  ...
  function handleNoteSave() {
    ...
    if (newNote) {
      noteData = { headlineId: $(this).data("article")._id, comments: newNote };
  ...
  function handleNoteDelete() {
    ...
    var noteToDeleteId = $(this).data("_id");
    var noteToDelete = $(this).data("_note0");
    console.log("NOTETODELETE ID = " + $(".btn.save").data("article"));
    // Perform an DELETE request to "/api/notes/" with the id of the note we're deleting as a parameter
    $.ajax({
      url: "/api/notes/" + noteToDeleteId + "|" + noteToDelete,
      method: "DELETE"
    }).then(function () {
